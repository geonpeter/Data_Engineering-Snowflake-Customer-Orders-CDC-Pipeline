...
with open('snowflake_credentials.json', 'r') as f:
    credentials = json.load(f)

# Extract individual values from the credentials dictionary
...
# Establish a connection to Snowflake using the credentials
